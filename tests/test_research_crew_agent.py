...
class TestPlannerAgentNode:
    ...
    def test_unicode_topic_embedded_in_outline(self):
        state = planner_agent_node(make_state(topic="ΘçÅσ¡Éπé│πâ│πâöπâÑπâ╝πâåπéúπâ│πé░"))
        assert state["plan_outline"][0] == "1. Executive Summary of ΘçÅσ¡Éπé│πâ│πâöπâÑπâ╝πâåπéúπâ│πé░"
